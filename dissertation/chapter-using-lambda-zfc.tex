...
\begin{itemize}
	\item \keyword{Extensional}: those whose equality, like that of sets, is determined only by their external properties, and not by how they are defined or constructed.
	\item \keyword{Intensional}: those whose equality is determined only by their internal properties.
\end{itemize}
...
\figref{fig:mapping-defs} defines other common mapping operations: $domain$, $range$, $preimage$ and $restrict$.
