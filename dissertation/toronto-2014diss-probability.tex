...
\chapter{The Semantics of Countable Models}
...
This chapter appears in condensed form in the proceedings of the 23\textsuperscript{rd} \emph{European Symposium on Programming (ESOP), 2014}.
