...
\newcommand{\ret}{return_s}
\newcommand{\bind}{bind_s}
...
\newcommand{\retset}{return_v}
\newcommand{\bindset}{bind_v}

\newcommand{\PS}[1]{\mathcal{M}\!\meaningof{#1}}

\newcommand{\objlang}[1]{\mathsf{#1}}
\newcommand{\Pmeas}{\mathbb{P}}
\newcommand{\Pspec}[1]{\objlang{P}\!\left[{#1}\right]}
...
\renewcommand{\objlang}[1]{\mathsf{#1}}
...
\renewcommand{\domain}{\objlang{domain}}
\renewcommand{\range}{\objlang{range}}
\renewcommand{\image}{\objlang{image}}
...
\makeatletter
\def\mycodehook{\tt\color{parenthesiscolor}\@setfontsize\small{11.5pt}{13pt}}
\makeatother
