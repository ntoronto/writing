...
We must first define a more extensional equivalence for preimage mappings.
...
Define the type constructors for the \mykeyword{bottom*}, \mykeyword{mapping*} and \mykeyword{preimage* arrows} as
\begin{equation}
\begin{aligned}
