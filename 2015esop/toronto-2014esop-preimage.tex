...
This section defines the semantics of nonrecursive, nonprobabilistic
programs, which interprets programs as preimage functions.
%
The following commutative diagram shows the relationships between the concrete arrows we define.
We will use it as a sort of roadmap; this section concerns the top row.
...
(a) ensure $ap\pre~(h~R)~N$ terminates,
(b) ensure each $r \in R$ contains enough random numbers, and
(c) determine how $random$ indexes numbers in $r$.
%
