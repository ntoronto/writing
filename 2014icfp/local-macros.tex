...
% Partially undo lmodern's takeover of default fonts (we really only want sans-serif)
...
\makeatletter
\def\mycodehook{\tt\color{parenthesiscolor}\@setfontsize\small{8pt}{9pt minus0.5pt}}
\makeatother
\let\schemecodehook\mycodehook
