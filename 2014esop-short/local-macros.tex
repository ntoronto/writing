...
\setlength\textfloatsep   {10pt \@minus 4\p@}
...
\setitemize{noitemsep,topsep=3pt}
\setenumerate{noitemsep,topsep=3pt}
...
\makeatletter
\def\mycodehook{\tt\color{parenthesiscolor}\@setfontsize\small{7.5pt}{8.5pt minus0.5pt}}
\makeatother
\let\schemecodehook\mycodehook
