...
Theorem~\ref{thm:approximation} guarantees that $refine~A \subseteq A$ (which implies termination), and that the algorithm is \keyword{sound}: the preimage of $B$ is always contained in the covering partition $refine^*$ returns.
